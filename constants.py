...
- question_number는 반드시 {jokbo_display_name}에 표시된 실제 문제 번호를 사용하세요 (예: 21번, 42번 등)
...
- 오직 {jokbo_display_name} 파일에 있는 문제만을 대상으로 분석하세요
- jokbo_page는 반드시 {jokbo_display_name}의 페이지 번호여야 하며, {lesson_display_name}의 페이지 번호를 사용하면 안 됩니다
- {lesson_display_name}은 오직 참고 자료로만 사용하고, 문제는 {jokbo_display_name}에서만 추출하세요"""
